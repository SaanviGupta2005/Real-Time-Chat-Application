...
const ScrollableChat = ({ messages, theme }) => {
              ...
              style={{
                backgroundColor: `${
                  m.sender._id === user?._id
                    ? theme === "dark"
                      ? "#353970" // Purple for the sender in dark theme
                      : "#BEE3F8" // Blue for the sender in light theme
                    : theme === "dark"
                      ? "#805AD5" // Darker purple for others in dark theme
                      : "#B9F5D0" // Green for others in light theme
                }`,
